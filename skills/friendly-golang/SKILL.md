...
| Security & Supply Chain | `govulncheck` as a CI gate, module proxy/checksum integrity, dependency upgrade policy | [references/security-supply-chain.md](references/security-supply-chain.md) |
